...
@router.get('/leagues/get_all_leagues', tags=['LEAGUES'])
def get_all_leagues():
    db = Session()
...
@router.post('/leagues/create_leagues', tags=['LEAGUES'])
...
@router.put('/leagues/update_leagues/{id}', tags=['LEAGUES'])
...
@router.delete('/leagues/delete_leagues/{id}', tags=['LEAGUES'])
